...
def get_ontologies():
    ...
    try:
        ...
        return jsonify({"count": len(ontologies), "ontologies": ontologies}), 200
...
def get_units():
    ...
    try:
        ...
        return jsonify({"count": len(units), "units": units}), 200
...
def get_value_types():
    ...
    try:
        ...
        return jsonify({"count": len(value_types), "value_types": value_types}), 200
...
def get_classifications():
    ...
    try:
        ...
        return jsonify({"count": len(classifications), "classifications": classifications}), 200
...
def get_ap243_statistics():
    ...
    try:
        ...
        return jsonify({"ap_level": 3, "ap_schema": "AP243", "statistics": stats}), 200
