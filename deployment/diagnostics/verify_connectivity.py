"""
MBSE Knowledge Graph - Connectivity Check (DEPRECATED LOCATION)
This script has been moved to scripts/verify_connectivity.py
...
new_script = os.path.join(project_root, "scripts", "verify_connectivity.py")

print("[NOTE] This script location is deprecated.")
print("       Please use: python scripts/verify_connectivity.py")
print("")
