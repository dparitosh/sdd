...
const navigationItems = [
  ...
  { name: 'GRAPH BROWSER', href: '/admin/graph', icon: Network, badge: 'Unified' },
  { name: 'QUERY STUDIO', href: '/admin/query-editor', icon: Terminal, badge: 'ADVANCED' },
  { name: 'REST API', href: '/admin/api-explorer', icon: Code },
  { name: 'PLM INTEGRATION', href: '/admin/plm', icon: Database },
  { name: 'ADVANCED SEARCH', href: '/admin/search', icon: Search },
  { name: 'ONTOLOGY MANAGER', href: '/admin/semantic/ontology', icon: Globe },
  { name: 'GRAPHQL', href: '/admin/semantic/graphql', icon: Code },
  { name: 'EXPRESS EXPLORER', href: '/admin/semantic/express', icon: Database },
  { name: 'OSLC BROWSER', href: '/admin/semantic/oslc', icon: Network },
];
            ...
            {navigationItems.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  {item.badge && (
                    <span className="bg-[#00B0E4] text-white text-[10px] px-2 py-0.5 rounded-full font-bold border-0">
                      {item.badge}
                    </span>
                  )}
                </Link>
          ...
          <div className="h-full px-8 flex items-center justify-between">
            ...
            <div className="flex-1 max-w-xl">
              <div className="relative">
                ...
                <input
                  type="search"
                  placeholder="Search systems, queries, APIs..."
