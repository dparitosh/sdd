...
export default function SimulationWorkspace() {
  ...
  // Fetch dossiers to get some real artifacts if possible
  ...
  const currentDossier = dossiers.length > 0 ? dossiers[0] : null;
  
  // Fallback to mock artifacts if no real ones exist
  const currentArtifacts = currentDossier?.artifacts || [
    { id: 'A1', name: 'Electromagnetic Field Analysis', requirementId: 'REQ-EM-01' },
    { id: 'B1', name: 'Thermal Dissipation Model', requirementId: 'REQ-TH-02' },
    { id: 'C1', name: 'Structural Integrity Mesh', requirementId: 'REQ-ST-01' },
    { id: 'D1', name: 'Vibration Harmonics', requirementId: 'REQ-VB-03' },
    { id: 'E1', name: 'Safety Factor Validation', requirementId: 'REQ-SF-01' },
    { id: 'F1', name: 'Material Properties Spec', requirementId: 'REQ-MP-01' },
  ];
    ...
    <div className="space-y-6 pb-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm relative overflow-hidden min-h-100 flex flex-col">
            ...
            <div className="flex-1 bg-slate-900 rounded-lg p-6 font-mono text-sm text-blue-400 overflow-y-auto max-h-75 border-l-4 border-blue-500 custom-scrollbar">
