...
def test_tools_connectivity():
    ...
    tests = [
        ...
        ("execute_cypher", lambda: tools.execute_cypher("MATCH (n:Class) RETURN n.name LIMIT 3")),
    ]
    ...
    for name, method, url in endpoints:
        try:
            ...
            if method == "GET":
                ...
                response = requests.post(url, json={"query": "MATCH (n:Class) RETURN n.name LIMIT 5"}, timeout=10)
