...
async def get_ontologies(
    ...
    try:
        ...
        WHERE owl.ap_level = 'AP243' AND {where_clause}
...
async def get_units(
    ...
    try:
        ...
        WHERE unit.ap_level = 'AP243' AND {where_clause}
...
async def get_classifications(
    ...
    try:
        ...
        WHERE class.ap_level = 'AP243' AND {where_clause}
...
async def get_ap243_statistics(api_key: str = Depends(get_api_key)):
    ...
    try:
        ...
        return {"ap_level": "AP243", "ap_schema": "AP243", "statistics": stats}
